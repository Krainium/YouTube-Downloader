  ...
  return (
    <header className="relative z-10 sticky top-0">
      ...
      <div
        ...
        style={{ background: "var(--accent, #ff3b3b)", opacity: 0.92 }}
      >
        <div
          style={{
        ...
        <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-6 text-sm">
            <a
              ...
              className="text-sub hover:text-text transition-colors flex items-center gap-1.5 min-h-[44px] min-w-[44px] justify-center sm:min-h-0 sm:min-w-0 sm:justify-start"
            >
